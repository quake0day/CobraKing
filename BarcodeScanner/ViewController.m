...
- (void)captureResult:(ZXCapture*)capture result:(ZXResult*)result {
    ...
    AudioServicesPlaySystemSound(kSystemSoundID_Vibrate);
        ...
        // update image view
        NSString *data = result.text;  // get the result and encode it (need change)
        data = [data stringByAppendingString:@" - après"];
       // NSString *data = @"wo,HenHaojjjjjjjjjjjjjjjjjjjjj[pppppppp'r5' -";
